...
import { ChecklistItem, Comment, Attachment } from '../context/TodoContext';
...
export default function AddTodoModal({ isOpen, onClose }: AddTodoModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className={`${bgColor} rounded-xl p-6 w-full max-w-md`}>
        <div className="flex justify-between items-center mb-4">
          <h2 className={`text-xl font-bold ${textColor}`}>Add New Task</h2>
